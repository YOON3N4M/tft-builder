import { generateTrait } from "@/utils/data";

// Origin
export const ARCANA = generateTrait(
  "아르카나",
  [2, 3, 4, 5],
...
export const CHRONO = generateTrait(
  "시공간",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["chrono"],
...
export const DRAGON = generateTrait(
  "용",
  [2, 3],
  ["silver", "gold"],
  ["dragon"],
...
export const DRUID = generateTrait("드루이드", [1], ["gold"], ["druid"], "", [
  "오공은 특성 추가 효과가 없지만, 대신 스킬이 강력하고 능력치가 높습니다.",
]);
export const ELDRITCH = generateTrait(
  "섬뜩한 힘",
  [3, 5, 7, 10],
...
export const FAERIE = generateTrait(
  "요정",
  [3, 5, 7, 9],
  ["bronze", "silver", "gold", "gold"],
  ["faerie"],
...
export const FROST = generateTrait(
  "서리",
  [3, 5, 7, 9],
  ["bronze", "silver", "gold", "prism"],
  ["frost"],
...
export const HONEYMANCY = generateTrait(
  "벌꿀술사",
  [3, 5, 7],
  ["bronze", "gold", "gold"],
  ["honeymancy"],
...
export const PORTAL = generateTrait(
  "차원문",
  [3, 6, 8, 10],
  ["bronze", "silver", "gold", "prism"],
  ["portal"],
...
export const PYRO = generateTrait(
  "화염",
  [2, 3, 4, 5],
  ["bronze", "silver", "gold", "gold"],
  ["pyro"],
...
export const RAVENOUS = generateTrait("허기", [1], ["gold"], ["ravenous"], "", [
  "잃은 플레이어 체력당 브라이어가 피해 증폭을 0.6% 얻습니다. 라운드마다 플레이어 체력을 3 소모해 브라이어에게 체력을 150 부여할 수 있는 간식 1개를 획득합니다.",
]);
export const SUGARCRAFT = generateTrait(
  "달콤술사",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["sugarcraft"],
...
export const WITCHCRAFT = generateTrait(
  "마녀",
  [2, 4, 6, 8],
  ["bronze", "silver", "gold", "gold"],
  ["witchcraft"],
...
//Class
export const ASCENDANT = generateTrait(
  "초월체",
  [1],
  ["gold"],
  ["ascendant"],
...
export const BASTION = generateTrait(
  "요새",
  [2, 4, 6, 8],
  ["bronze", "silver", "gold", "gold"],
  ["bastion"],
...
export const BAT_QUEEN = generateTrait(
  "박쥐여왕",
  [1],
  ["gold"],
  ["bat_queen"],
...
export const BEST_FRIEND = generateTrait(
  "단짝",
  [1],
  ["gold"],
  ["best_friend"],
...
export const BLASTER = generateTrait(
  "폭파단",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["blaster"],
...
export const HUNTER = generateTrait(
  "사냥꾼",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["hunter"],
...
export const INCANTOR = generateTrait(
  "마도사",
  [2, 4],
  ["silver", "gold"],
  ["incantor"],
...
export const MAGE = generateTrait(
  "요술사",
  [3, 5, 7, 9],
  ["bronze", "silver", "gold", "gold"],
  ["mage"],
...
export const MULTISTRIKER = generateTrait(
  "쇄도자",
  [3, 5, 7, 9],
  ["bronze", "silver", "gold", "gold"],
  ["multistriker"],
...
export const PRESERVER = generateTrait(
  "보호술사",
  [2, 3, 4, 5],
...
export const SCHOLAR = generateTrait(
  "학자",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["scholar"],
...
export const SHAPESHIFTER = generateTrait(
  "형상변환자",
  [2, 4, 6, 8],
  ["bronze", "silver", "gold", "prism"],
  ["shapeshifter"],
...
export const VANGUARD = generateTrait(
  "선봉대",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["vanguard"],
...
export const WARRIOR = generateTrait(
  "전사",
  [2, 4, 6],
  ["bronze", "silver", "gold"],
  ["warrior"],
...
export const SET_12_TRAIT_LIST = [
  ARCANA,
  CHRONO,
  DRAGON,
  DRUID,
