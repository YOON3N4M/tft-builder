...
import { CoreItem } from "@/types/data";
import { generateItem } from "@/utils/data";
...
export const SET_12_COMBINATION_ITEM_LIST = [
  BF_SWRORD,
...
export const SET_12_CORE_ITEM_LIST: CoreItem[] = [
  DEATH_BLADE,
  GIANTS_SLAYER,
  SPEAR_OF_SHOJIN,
  HAND_OF_JUSTICE,
...
export const SET_12_EMBLEM_ITEM_LIST: CoreItem[] = [
  FROST_EMBLEM,
  WITCHCRAFT_EMBLEM,
  HONEYMANCY_EMBLEM,
  ELDRITCH_EMBLEM,
